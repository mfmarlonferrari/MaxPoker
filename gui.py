...
class GUI(object):
    ...
    def __init__(self, master):
        master.geometry('985x720+0+0')
        master.resizable(0,0)
        master.title('PokerNight')

        self.canvas = Canvas(master=master, width=985, height=700, borderwidth=0, highlightthickness=0)
        self.canvas.pack()
